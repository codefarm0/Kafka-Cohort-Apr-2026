...
/**
 * Day 6 demo: POST order events to the orders topic. Body should include customerId, totalAmount; optional categoryId.
 */
@RestController
...
public class OrderController {
	...
	private String toJson(Map<String, Object> body) {
		if (body == null || body.isEmpty()) {
			return "{\"customerId\":\"default\",\"totalAmount\":0.0,\"categoryId\":\"default\"}";
		}
		try {
