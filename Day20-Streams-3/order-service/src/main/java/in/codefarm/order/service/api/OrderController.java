...
/**
 * Day 3 demo: POST order events to the orders topic. Key = customerId (for windowed count per customer).
 * Optional query param key= to override the Kafka record key.
 */
@RestController
...
public class OrderController {
	...
	public ResponseEntity<Map<String, Object>> placeOrder(
		...
		String customerId = (body != null && body.get("customerId") != null) ? String.valueOf(body.get("customerId")) : "default";
		String recordKey = (key != null && !key.isBlank()) ? key : "customer-" + customerId;
