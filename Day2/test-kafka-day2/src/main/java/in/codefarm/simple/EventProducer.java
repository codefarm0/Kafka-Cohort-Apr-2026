...
public class EventProducer {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
        new EventProducer().sendEvent("message -  " + i);
    }
    }
    boolean sendEvent(String message){
        ...
        ProducerRecord<String, String> record = new ProducerRecord<>("test-new-topic","fixed-key", message);
