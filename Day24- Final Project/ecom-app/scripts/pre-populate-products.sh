...
# Script to pre-populate products in product-service
# Usage: ./pre-populate-products.sh [product-service-url]

INVENTORY_SERVICE_URL=${1:-http://localhost:8082}

echo "Pre-populating products in product-service at $INVENTORY_SERVICE_URL"
echo ""
