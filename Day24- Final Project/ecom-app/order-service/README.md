...
- ✅ **Direct Kafka publish** to `orders` topic after DB commit; **Redis** reservation (60s TTL) on `reserve:order:{orderId}`
...
### Order flow (HLD Phase 2)

### Legacy: Outbox Pattern with Debezium CDC (removed)
